                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data text">
                        <div class="input-group date">
                            ...
                            <input type="text" name="departureTime" class="form-control pull-right" id="dateTimePicker">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 data text">
                        <select name="productStatus" class="form-control select2" style="width: 100%">
