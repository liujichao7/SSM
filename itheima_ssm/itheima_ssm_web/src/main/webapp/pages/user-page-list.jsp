    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/user/findAll.do?page=1&pageSize=4">用户管理</a></li>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <c:if test="${not pageInfo.isFirstPage}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/user/findAll.do?page=${pageInfo.firstPage}&pageSize=${pageInfo.pageSize}" aria-label="Previous">首页</a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/user/findAll.do?page=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a>
                                </li>
                            </c:if>
                            ...
                            <c:if test="${not pageInfo.isLastPage}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/user/findAll.do?page=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}">下一页</a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/user/findAll.do?page=${pageInfo.lastPage}&pageSize=${pageInfo.pageSize}" aria-label="Next"  >尾页</a>
                                </li>
                            </c:if>
                        </ul>
                    </div>
